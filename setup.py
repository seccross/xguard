...
setup(
    ...
    description="slither is a static analyzer to find the inconsistency behavior of cross-chain bridges in the real world.",
    url="https://github.com/seccross/slither",
