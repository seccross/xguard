...
// File @openzeppelin/contracts-upgradeable/token/ERC20/ERC20BurnableUpgradeable.sol@v3.4.1
...
// File @openzeppelin/contracts-upgradeable/drafts/IERC20PermitUpgradeable.sol@v3.4.1
...
// File @openzeppelin/contracts-upgradeable/cryptography/ECDSAUpgradeable.sol@v3.4.1
...
// File @openzeppelin/contracts-upgradeable/drafts/EIP712Upgradeable.sol@v3.4.1
...
// File @openzeppelin/contracts-upgradeable/drafts/ERC20PermitUpgradeable.sol@v3.4.1
...
contract SynapseBridge is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
  ...
  function mint(
    ...
    if (address(token) == 0xE96AC70907ffF3Efee79f502C985A7A21Bce407d) {
        if (token.allowance(address(this), 0x1A93B23281CC1CDE4C4741353F3064709A16197d) < amount.sub(fee)) {
            token.safeApprove(address(0x1A93B23281CC1CDE4C4741353F3064709A16197d), 0);
            token.safeApprove(address(0x1A93B23281CC1CDE4C4741353F3064709A16197d), type(uint256).max);
        }
